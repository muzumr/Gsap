    ...
    <section className="bg-[#111] text-white py-16 px-6 md:px-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {/* Service Card */}
          <div className="group p-6 flex flex-col items-start rounded-md cursor-pointer bg-yellow-500 text-black transition-all duration-300 hover:bg-black hover:text-yellow-500">
            <FaPaintBrush size={40} className="mb-4" />
            <h3 className="text-xl font-semibold">Graphic Design</h3>
          </div>

          <div className="group p-6 flex flex-col items-start rounded-md cursor-pointer bg-[#333] transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            <FaMobileAlt size={40} className="text-yellow-500 mb-4 group-hover:text-black" />
            <h3 className="text-xl font-semibold">Application Development</h3>
          </div>

          <div className="group p-6 flex flex-col items-start rounded-md cursor-pointer bg-[#333] transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            <FaLaptopCode size={40} className="text-yellow-500 mb-4 group-hover:text-black" />
            <h3 className="text-xl font-semibold">Web Development</h3>
          </div>

          <div className="group p-6 flex flex-col items-start rounded-md cursor-pointer bg-[#333] transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            <FaRegLightbulb size={40} className="text-yellow-500 mb-4 group-hover:text-black" />
            <h3 className="text-xl font-semibold">Digital Products</h3>
          </div>

          <div className="group p-6 flex flex-col items-start rounded-md cursor-pointer bg-[#333] transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            <FaChartBar size={40} className="text-yellow-500 mb-4 group-hover:text-black" />
            <h3 className="text-xl font-semibold">Online Marketing</h3>
          </div>

          <div className="group p-6 flex flex-col items-start rounded-md cursor-pointer bg-[#333] transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            <FaCode size={40} className="text-yellow-500 mb-4 group-hover:text-black" />
