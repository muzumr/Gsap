...
const App = () => {
  return (
    <div className="flex flex-col items-center py-10 px-4 space-y-8 bg-gray-100 h-[70vh]">
      {/* Title Section */}
      ...
      <div className="flex flex-wrap justify-center items-center space-x-6 space-y-4 md:space-y-0 md:flex-nowrap">
        {courses.map((course) => (
          <div
            key={course.name}
            className="flex flex-col items-center space-y-2 border border-gray-300 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow w-20 md:w-auto"
          >
      ...
      <div className="w-full max-w-lg px-4 md:px-0">
        <div className="flex flex-col md:flex-row items-center md:items-center md:border-t border-gray-200 pt-4">
          ...
          {/* Social Links */}
          <div className="flex justify-center md:justify-start space-x-3 md:pl-4">
