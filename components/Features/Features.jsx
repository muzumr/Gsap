...
const Features = () => {
  return (
    <div className="flex flex-col items-center px-6 py-10 space-y-10 bg-gray-100 min-h-screen">
      {/* Title Section */}
      <div className="text-center space-y-4">
        <span className="bg-yellow-400 text-white px-4 py-1 rounded-full font-semibold uppercase text-xs">
          Feature
        </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {features.map((feature) => (
          ...
          >
            <div className="relative flex items-center justify-center w-16 h-16 rounded-full bg-yellow-400 text-white text-2xl">
