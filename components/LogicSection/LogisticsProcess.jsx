...
const LogisticsProcess = () => {
  return (
    <section className="bg-[#f8fbfe] py-16 px-4 min-h-screen flex flex-col items-center relative">
      {/* Header Section */}
      <div className="text-center mb-12 max-w-2xl">
        <p className="text-green-600 font-semibold">OUR WORK PROCESS</p>
      ...
      {/* SVG Curve */}
      <svg
        className="absolute top-[38vh] left-0 right-0 mx-auto hidden lg:block"
        width="100%"
        height="200"
