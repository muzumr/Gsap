...
const Circle = () => {
  return (
    <div className="relative min-h-screen pl-[30vw] items-center justify-center bg-black hidden md:block">
      {/* Background */}
      <div
      ...
      <div className="yellow-circle relative flex items-center justify-center w-[70vh] h-[70vh] bg-white rounded-full shadow-lg shadow-black mb-[10vh]">
        <div className=" parent text-center-circle absolute text-center text-white font-bold text-2xl bg-black rounded-full h-[50vh] w-[50vh] flex justify-center items-center flex-col">
          <p>INFOGRAPHIC</p>
          <p>TEMPLATE</p>
          <FaGlobe className="text-yellow-500 text-4xl mb-[1%] mr-2" />
        </div>
        ...
        <div className="absolute w-full h-full flex flex-col items-center justify-between px-10 py-5 mt-[49vh]">
          ...
          <div className="info-box frontend-development flex items-center space-x-3 absolute top-[12vh] -left-[9vw] transform -translate-x-1/4">
            <div className="flex items-center justify-center w-[17vw] h-[15vh] bg-gray-800 text-white p-3 rounded-full shadow-md shadow-yellow-500">
              <div className="flex items-center">
                <FaCode className="text-yellow-500 text-4xl mb-[1%] mr-2" />
                <span>
              ...
              <div>
                <span className="font-bold text-yellow-500">01</span>
          ...
          <div className="info-box backend-development flex items-center space-x-3 absolute bottom-[24vh] -left-[1vh] transform -translate-x-1/2">
            <div className="flex items-center justify-center w-[17vw] h-[15vh] bg-gray-800 text-white p-3 rounded-full shadow-md shadow-yellow-500">
              <div className="flex items-center">
                <FaServer className="text-yellow-500 text-4xl mb-[1%] mr-2" />
                <span>
                  <svg width="2" height="70" className="my-2 mx-2">
                    <line x1="2" y1="0" x2="2" y2="80" stroke="white" strokeWidth="4" />
                  </svg>
              ...
              <div>
                <span className="font-bold text-yellow-500">02</span>
          ...
          <div className="info-box uiux-design flex items-center space-x-3 absolute bottom-10 left-0 transform -translate-x-1/2">
            <div className="flex items-center justify-center w-[17vw] h-[15vh] bg-gray-800 text-white p-3 rounded-full shadow-md shadow-yellow-500 ml-[12vw]">
              <div className="flex items-center">
                <FaPalette className="text-yellow-500 text-4xl mb-[1%] mr-2" />
                <span>
                  <svg width="2" height="70" className="my-2 mx-2">
                    <line x1="2" y1="0" x2="2" y2="80" stroke="white" strokeWidth="4" />
                  </svg>
              ...
              <div>
                <span className="font-bold text-yellow-500">03</span>
          ...
          <div className="info-box database-management flex items-center space-x-3 absolute bottom-10 right-0 transform translate-x-1/2">
            <div className="flex items-center justify-center w-[17vw] h-[15vh] bg-gray-800 text-white p-3 rounded-full shadow-md shadow-yellow-500 mr-[15vw]">
              <div className="flex items-center">
                <FaDatabase className="text-yellow-500 text-4xl mb-[1%] mr-2" />
                <span>
                  <svg width="2" height="70" className="my-2 mx-2">
                    <line x1="2" y1="0" x2="2" y2="80" stroke="white" strokeWidth="4" />
                  </svg>
              ...
              <div>
                <span className="font-bold text-yellow-500">04</span>
          ...
          <div className="info-box devops flex items-center space-x-3 absolute bottom-[24vh] right-[1vw] transform translate-x-1/2">
            <div className="flex items-center justify-center w-[17vw] h-[15vh] bg-gray-800 text-white p-3 rounded-full shadow-md shadow-yellow-500">
              <div className="flex items-center">
                <FaTools className="text-yellow-500 text-4xl mb-[1%] mr-2" />
                <span>
                  <svg width="2" height="70" className="my-2 mx-2">
                    <line x1="2" y1="0" x2="2" y2="80" stroke="white" strokeWidth="4" />
                  </svg>
              ...
              <div>
                <span className="font-bold text-yellow-500">05</span>
          ...
          <div className="info-box testing flex items-center space-x-3 absolute top-[12vh] -right-[9vw] transform translate-x-1/4">
            <div className="flex items-center justify-center w-[17vw] h-[15vh] bg-gray-800 text-white p-3 rounded-full shadow-md shadow-yellow-500">
              <div className="flex items-center">
                <FaBug className="text-yellow-500 text-4xl mb-[1%] mr-2" />
                <span>
                  <svg width="2" height="70" className="my-2 mx-2">
                    <line x1="2" y1="0" x2="2" y2="80" stroke="white" strokeWidth="4" />
                  </svg>
              ...
              <div>
                <span className="font-bold text-yellow-500">06</span>
